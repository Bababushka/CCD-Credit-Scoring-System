...
## Repository Access
This project is currently hosted locally and does not have an active remote GitHub repository configured.

**Location**: `C:\Users\User\Downloads\ChinHinOption3_CashMeIfYouCan`
...
| `app/src/pages/CaseDetail.tsx` | Main UI for viewing case details and analysis. |
| `backend/app/models.py` | Database schema definition. |
